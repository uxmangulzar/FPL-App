...
public class ArtistDetailsDTO1 implements Serializable {
    ...
    String description = "";
    String about_us = "";
    ArrayList<SkillsDTO1> skills = new ArrayList<>();
    String image = "";
    ...
    String ava_rating = "";
    ArrayList<ProductDTO1> products = new ArrayList<>();
    ArrayList<ReviewsDTO1> reviews = new ArrayList<>();
    ArrayList<GalleryDTO1> gallery = new ArrayList<>();
    ArrayList<QualificationsDTO1> qualifications = new ArrayList<>();
    ArrayList<ArtistBookingDTO1> artist_booking = new ArrayList<>();
    String earning = "";
    String jobDone = "";
    String totalJob = "";
    ...
    public ArrayList<SkillsDTO1> getSkills() {
        return skills;
    }

    public void setSkills(ArrayList<SkillsDTO1> skills) {
        this.skills = skills;
    }
    ...
    public ArrayList<ProductDTO1> getProducts() {
        return products;
    }

    public void setProducts(ArrayList<ProductDTO1> products) {
        this.products = products;
    }

    public ArrayList<ReviewsDTO1> getReviews() {
        return reviews;
    }

    public void setReviews(ArrayList<ReviewsDTO1> reviews) {
        this.reviews = reviews;
    }

    public ArrayList<GalleryDTO1> getGallery() {
        return gallery;
    }

    public void setGallery(ArrayList<GalleryDTO1> gallery) {
        this.gallery = gallery;
    }

    public ArrayList<QualificationsDTO1> getQualifications() {
        return qualifications;
    }

    public void setQualifications(ArrayList<QualificationsDTO1> qualifications) {
        this.qualifications = qualifications;
    }

    public ArrayList<ArtistBookingDTO1> getArtist_booking() {
        return artist_booking;
    }

    public void setArtist_booking(ArrayList<ArtistBookingDTO1> artist_booking) {
