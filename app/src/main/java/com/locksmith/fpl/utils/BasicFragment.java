...
public class BasicFragment extends Fragment {
    ...
    public static BasicFragment newInstance(Uri uri) {
        BasicFragment fragment = new BasicFragment();
        Bundle args = new Bundle();
        args.putString(KEY_SOURCE_URI, uri.toString());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(KEY_SOURCE_URI);
        }
    }
    ...
    private void bindViews(View view) {
        ...
        view.findViewById(R.id.ivBack).setOnClickListener(btnListener);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.buttonRotateRight:
                    ...
                    break;
                case R.id.ivBack:
                    ((BasicActivity) getActivity()).goBack();
                    break;
