...
public class PostRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = PostRequestActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = PostRequestActivity.this;
    ...
    public void setUiAction() {
        ...
        builder = new BottomSheet.Builder(PostRequestActivity.this).sheet(R.menu.menu_cards);
    ...
    private void checkPermissions() {
        Dexter.withContext(PostRequestActivity.this)
                .withPermissions(
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            new AlertDialog.Builder(PostRequestActivity.this)
        ...
        if (requestCode == CROP_GALLERY_IMAGE) {
            if (data != null) {
                ...
                Glide.with(mContext).load(picUri).placeholder(R.drawable.imagethumbnail)
                        ...
                        .into(ivImg);
                path = getPath(PostRequestActivity.this, picUri);
                if (path != null) {
    ...
    public void startCropping(Uri uri, int requestCode) {
        ...
        Intent intent = new Intent(PostRequestActivity.this, BasicActivity.class);
    ...
    private void openBottomSheetDialog() {
        bottomSheetDialog = new BottomSheetDialog(PostRequestActivity.this);
        View view = LayoutInflater.from(PostRequestActivity.this).inflate(R.layout.bottom_selection_dailog, null);
        ...
        LinearLayoutManager rvCouponManager = new LinearLayoutManager(PostRequestActivity.this, LinearLayoutManager.VERTICAL, false);
        choose_topic_recycler.setLayoutManager(rvCouponManager);
        chooseTopicAdapter = new ChooseTopicAdapter(PostRequestActivity.this, choose_topic_recycler, topic_list, at_topic_txt, "1");
    ...
    public boolean validateCategory() {
        if (at_topic_txt.getText().equals("ALL CATEGORIES")) {
            ProjectUtils.showToast(PostRequestActivity.this, "Please select a category");
            return false;
        } else {
            return true;
        }
    ...
    public void addPost() {
        ...
        if (path != null) {
            ProjectUtils.showCustomProgressDialog(PostRequestActivity.this, getResources().getString(R.string.please_wait));
            ...
            try {
                new ProjectUtils().showErrorDialog((Activity) mContext, "Without picture you can't post job", new ProjectUtils.onDialogClickListener() {
                    @Override
